...
![Three guided investigations complete in median 1.49 to 1.90 seconds through 11 MCP tool calls and a provider reconnect](assets/benchmark-navigation.svg)
...
| Follow workflow policy dispatch | **1.56 s** |
| Investigate MCP binary selection | **1.90 s** |
...
bug fixes or an agent productivity comparison. All samples, including the
7.96 s outlier, are published with the methodology.
